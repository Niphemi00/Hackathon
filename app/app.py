    ...
    if __name__ == "__main__":
        ...
        if submit:
            try:
                ...
                prob = predict(model, scaler, feature_names, input_dict)
...
def predict(model, scaler, feature_names, input_dict: dict) -> int:
    if model is None or scaler is None or feature_names is None:
        raise Exception("Model is not available, cannot make predictions.")
